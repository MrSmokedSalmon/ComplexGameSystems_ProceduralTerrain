...
public class TutorialHelicopterController : MonoBehaviour
{
	...
	private void Update()
	{
		...
		ui.UpdateIndicators(transform.localRotation.eulerAngles.z, transform.localRotation.eulerAngles.x, 
	...
	private void FixedUpdate()
	{
		...
		rigidbody.AddTorque(transform.right * roll * responsiveness);
